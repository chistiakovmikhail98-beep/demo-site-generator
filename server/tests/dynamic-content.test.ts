...
interface PreviewResponse {
  preview: {
    name: string;
    niche: string;
    directions?: Array<{ title: string }>;
    calculatorStages?: Array<{ status: string; description: string }>;
    heroTitle?: string;
  };
  fullConfig: {
    brand: { name: string; tagline: string; niche: string };
    calculatorStages?: Array<{ status: string; description: string; tags: string[] }>;
...
async function test1_DanceStudio() {
  ...
  if (!data.preview.name) throw new Error('Нет названия студии');
