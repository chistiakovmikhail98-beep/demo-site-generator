...
const Calculator: React.FC = () => {
  ...
  const result = useMemo(() => {
    ...
    const totalHours = Math.round(totalClasses * 1); // avg 1h per healthy movement session
    ...
    if (totalClasses <= 12) {
      status = "Снятие зажимов";
      percentage = 15;
      description = "Вы научитесь правильно дышать, разгрузите нервную систему и почувствуете первое облегчение в спине и шее.";
      tags = ["Дыхание", "Релакс", "Снятие боли"];
      achievement = "Первый день без боли в спине";
    } else if (totalClasses <= 36) {
      status = "Осознанное тело";
      percentage = 45;
      description = "Возвращается естественная мобильность суставов. Тело становится послушным, уходит привычка сутулиться.";
      tags = ["Мобильность", "Осанка", "Гибкость"];
      achievement = "Привычка держать спину ровно";
    } else if (totalClasses <= 72) {
      status = "Сильный корсет";
      percentage = 80;
      description = "Глубокие мышцы-стабилизаторы укреплены. Вы чувствуете легкость в каждом движении и высокий уровень энергии.";
      tags = ["Глубокий кор", "Баланс", "Стабильность"];
      achievement = "Свобода движений без ограничений";
    } else {
      status = "Системное здоровье";
      percentage = 100;
      description = "Здоровое движение становится вашим образом жизни. Тело работает как единый слаженный механизм без боли.";
      tags = ["Биомеханика", "Выносливость", "Гармония"];
      achievement = "Полная трансформация здоровья";
    }
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-zinc-400 text-sm md:text-xl max-w-2xl mx-auto font-medium">
              Узнай, чего ты достигнешь в Студии Виктории Марус, занимаясь регулярно
            </p>
        </div>
