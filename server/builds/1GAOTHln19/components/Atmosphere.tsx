...
const STEPS = [
  {
    id: 0,
    title: "Пространство",
    subtitle: "Уют и профессионализм",
    text: "Наша студия — это место, где всё продумано для вашего комфорта. Светлые залы с профессиональным оборудованием для пилатеса и здорового движения.",
  ...
  },
  {
    ...
    text: "Мы начинаем работу с глубокой оценки опорно-двигательного аппарата. Это фундамент для составления вашей персональной программы восстановления.",
  ...
  },
  {
    id: 2,
    title: "Занятия",
    subtitle: "Движение без боли",
    text: "Тренировки проходят под контролем опытных наставников. Мы учим ваше тело двигаться правильно, легко и без лишнего напряжения.",
  ...
  },
  {
    id: 3,
    title: "Оборудование",
    subtitle: "Современные методики",
    text: "Использование специализированного инвентаря помогает проработать глубокие мышцы, которые сложно задействовать в обычном фитнесе.",
