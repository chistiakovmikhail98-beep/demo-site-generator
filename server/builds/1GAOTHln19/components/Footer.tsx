    ...
    <footer id="footer" className="bg-[#121215] border-t border-zinc-900 text-zinc-200">
      <Section>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-8 md:p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden h-full flex flex-col">
               ...
               <div className="space-y-6 mb-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-white font-bold text-lg">ул. Рыленкова, 49</p>
                      <p className="text-zinc-500 text-sm">г. Смоленск, ТЦ Кривич, 2 этаж.</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <Phone className="text-primary shrink-0 w-6 h-6" />
                    <div>
                        <p className="text-white font-bold">+7 (960) 582-22-04</p>
                  ...
                  <div className="flex items-center gap-4 pt-6 border-t border-zinc-800 mt-8">
                    <a href="https://t.me/viktoriamarus" target="_blank" className="p-3 bg-zinc-800 rounded-full hover:bg-primary transition-all duration-300">
                      <Send className="w-5 h-5 text-white" />
                    </a>
                    <a href="https://vk.ru/viktoriamarusstudio" target="_blank" className="p-3 bg-zinc-800 rounded-full hover:bg-primary transition-all duration-300">
                      <div className="w-5 h-5 text-white flex items-center justify-center font-bold text-xs">VK</div>
                    </a>
                    <a href="https://www.instagram.com/viktoria_marus_studio" target="_blank" className="p-3 bg-zinc-800 rounded-full hover:bg-primary transition-all duration-300">
               ...
               <div className="mt-auto flex flex-col gap-3">
                   <div className="overflow-hidden rounded-2xl border border-zinc-800 shadow-inner h-48 md:h-64 relative group">
                      <iframe 
                        src="https://yandex.ru/map-widget/v1/?ll=32.096285%2C54.753360&z=18" 
                        width="100%" 
                        height="100%" 
                   ...
                   <div className="flex gap-2">
                       <a 
                         href="https://yandex.ru/maps/12/smolensk/?text=ул.+Рыленкова,+49" 
                         target="_blank" 
        ...
        <div className="text-center pt-8 border-t border-zinc-900 text-zinc-600 text-sm font-medium">
          © 2024 Студия здорового движения Виктории Марус. <br className="md:hidden" /> Все права защищены.
        </div>
      </Section>
    </footer>
  );
