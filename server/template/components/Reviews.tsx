        ...
        <div className="flex overflow-hidden">
          <div className="flex gap-6 animate-marquee-right w-max px-3">
            {[...REVIEWS, ...REVIEWS].map((review, idx) => (
              <div 
                key={idx} 
                className="w-[280px] md:w-[400px] bg-white p-5 md:p-8 rounded-[1.5rem] md:rounded-[2rem] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.05)] border border-zinc-100 flex flex-col gap-3 md:gap-4 flex-shrink-0 hover:shadow-xl transition-all duration-300"
              >
